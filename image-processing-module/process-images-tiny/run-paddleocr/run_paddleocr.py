...
if __name__ == "__main__":
    ...
    with open("{}/{}_confirmation-paddleocr.json".format(tiny_results_storage, to_process), "a+") as out:
        for t in thumbnails:
            try:
    ...
    with open('{}/{}_log-paddleocr.txt'.format(tiny_results_storage, to_process), 'a+') as f:
